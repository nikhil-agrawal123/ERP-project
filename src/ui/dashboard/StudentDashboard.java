...
public class StudentDashboard extends JFrame {
    ...
    public StudentDashboard(String rollNum, String username) {
        ...
        // Safe Icon Loading
        java.net.URL iconUrl = getClass().getResource("/logo.jpg");
        if (iconUrl != null) {
        ...
        mainContentPanel.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                if (hamburgerButton != null) {
                    ...
                    // Fix: Ensure the button has a size even if text is empty
                    if (hamBtnSize.width == 0) hamBtnSize = new Dimension(50, 50);
    ...
    private void toggleMenu() {
        ...
        // 1. HIDE Hamburger immediately when opening
        if (isMenuOpen) {
        ...
        menuTimer = new Timer(5, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Revalidate the FRAME to force BorderLayout update
                sideMenuPanel.revalidate();
                StudentDashboard.this.revalidate();
                StudentDashboard.this.repaint();

                if (finished) {
                    ((Timer)e.getSource()).stop();
                    // 2. SHOW Hamburger only when fully closed
                    if (!isMenuOpen) {
    ...
    private JPanel createSideMenuPanel() {
        ...
        closeMenuButton.setFont(new Font("Segoe UI", Font.BOLD, 22));
        ...
        RoundedButton calendarButton = createSideMenuButton("Calendar");
        ...
        logoutButton.setPreferredSize(new Dimension(Integer.MAX_VALUE, 45));
    ...
    // This class is used as an Icon, NOT a Button
    ...
    private void createContentCards(JPanel cardHolder, String rollNum, String username) {
        ...
        // Assumes StudentCoursesPanel constructor matches this
    ...
    private JPanel createStatBox(String title, String value) {
        ...
        valueLabel.setFont(new Font("Segoe UI Semibold", Font.BOLD, 64));
    ...
    private JPanel createMinorProgramsPanel() {
        ...
        moreLinksTitle.setFont(new Font("Segoe UI", Font.BOLD, 20));
